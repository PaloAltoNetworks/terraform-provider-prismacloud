...
prismacloud_account_group.example: Creating...
prismacloud_account_group.example: Creation complete after 2s [id=fb30ef66-4b1d-*********8]
...
# prismacloud_account_group.example will be destroyed
- resource "prismacloud_account_group" "example" {
    - account_ids      = [
        - "53905******",
        - "398411*****",
          ] -> null
    - description      = "Made by Terraform" -> null
    - group_id         = ********************* -> null
    - id               = ******************** -> null
    - last_modified_by = ************ -> null
    - last_modified_ts = ********** -> null
    - name             = "account_group_example" -> null
      }
...
prismacloud_account_group.example: Destroying... [id=fb30ef66-4b1d-***************]
prismacloud_account_group.example: Destruction complete after 1s
```